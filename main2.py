    ...
    while True:
        ...
        while retry_count < 10:
            ...
            try:
                ...
                print(f'{thread_color}[Thread {thread_num}]{Style.RESET_ALL} Treść odpowiedzi: {response.text} Kod: {response.status_code}')
                ...
                print(f'{thread_color}[Thread {thread_num}]{Style.RESET_ALL} Odpowiedź serwera: {response.text}({e.response.status_code})')
                break
